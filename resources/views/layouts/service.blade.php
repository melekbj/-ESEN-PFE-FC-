  ...
  <div class="container-fluid bg-primary py-5 hero-header mb-5">
    <div class="row py-3">
        <div class="col-12 text-center">
            ...
            <a href="" class="h4 text-white">Nos Services</a>
        </div>
    </div>
</div>
<!-- Hero End -->
        ...
        <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="col-lg-5 service-item wow zoomIn" data-wow-delay="0.9s">
                <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-4">
                    <h3 class="text-white mb-3">Et Plein D'autres Services Dont Vous Aurez Besoin</h3>
                    <p class="text-white mb-3 ">Vous trouverez tout cela seulement sur </p>
                    <h2 class="text-white mb-0">FastCare</h2>
                </div>
            </div>
        </div>
    </div>
