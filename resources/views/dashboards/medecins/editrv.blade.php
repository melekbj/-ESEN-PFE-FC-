...
<div class=" col-md-4 mt-5 " style="margin-left: 35%;">
  ...
  <div class="">
      ...
      <form action="{{ url('rendezvous/' .$rendezv->id) }}" method="post">
        @csrf
        @method("PATCH")
        ...
        <label>Heure</label>
        <input type="time" name="heureRdv" id="heureRdv" value="{{$rendezv->heureRdv}}" min="09:00" max="16:00" class="form-control mb-3">
        {{-- <label>Role</label></br>
